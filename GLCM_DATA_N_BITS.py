...
#for nbits in [12]:
        ...
        #for i in [0,1,2,3,4]:
                ...
                #print array[139,1477]
                #if (nbits == 8 ): array[139,1477] = 255
...
#for nbits in [2,3,4,5,6,7,8]:
        ...
        #for itIndex in range(niterations):
                ...
                #svm.train_auto(np.float32(obDataSet.atributes[obData.Training_indexes]),np.float32(obDataSet.labels[obData.Training_indexes]),None,None,obData.params, k_fold = 3)
        ...
        #print exp
        #exp.save("EXPERIMENTS/EXP01-GLCM+SVM-2_8bN.txt")

####################################################################################################################################
exp = exp.load("EXPERIMENTS/EXP01-GLCM+SVM-2_8bN.txt")
print exp.experimentResults[-1].dataSet[5]